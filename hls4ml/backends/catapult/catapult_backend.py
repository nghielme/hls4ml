...
class CatapultBackend(FPGABackend):
    ...
    def _register_flows(self):
        ...
        writer_flow_requirements = ['optimize', catapult_types_flow, template_flow]
        ...
        extras = [
            ...
            opt_pass for opt_pass in all_passes if opt_pass not in initializers + streaming_passes + quantization_passes + optimization_passes + catapult_types + templates + writer_passes
        ]
        ...
        ip_flow_requirements = ['optimize', init_flow, streaming_flow, quantization_flow, optimization_flow, catapult_types_flow, extras_flow, template_flow]
    ...
    def build(self, model, reset=False, csim=True, synth=True, cosim=True, validation=False, export=False, vsynth=False):
        ...
        ccs_args = '"reset={reset} csim={csim} synth={synth} cosim={cosim} validation={validation} export={export} vsynth={vsynth}"'.format(reset=reset, csim=csim, synth=synth, cosim=cosim, validation=validation, export=export, vsynth=vsynth)
