...
class XilinxWriter(Writer):
    ...
    def write_project_cpp(self, model):
        ...
        f = open(os.path.join(filedir, '../templates/xilinx/firmware/myproject.cpp'))
    ...
    def write_project_header(self, model):
        ...
        filedir = os.path.dirname(os.path.abspath(__file__))
        f = open(os.path.join(filedir, '../templates/xilinx/firmware/myproject.h'))
    ...
    def write_defines(self, model):
        ...
        """
        filedir = os.path.dirname(os.path.abspath(__file__))
        f = open(os.path.join(filedir, '../templates/xilinx/firmware/defines.h'))
    ...
    def write_parameters(self, model):
        ...
        """
        filedir = os.path.dirname(os.path.abspath(__file__))
        f = open(os.path.join(filedir, '../templates/xilinx/firmware/parameters.h'))
    ...
    def write_test_bench(self, model):
        ...
        f = open(os.path.join(filedir, '../templates/xilinx/myproject_test.cpp'))
    ...
    def write_bridge(self, model):
        ...
        filedir = os.path.dirname(os.path.abspath(__file__))
        f = open(os.path.join(filedir, '../templates/xilinx/myproject_bridge.cpp'))
    ...
    def write_build_script(self, model):
        ...
        # build_prj.tcl
        srcpath = os.path.join(filedir, '../templates/xilinx/build_prj.tcl')
        dstpath = f'{model.config.get_output_dir()}/build_prj.tcl'
        copyfile(srcpath, dstpath)

        # vivado_synth.tcl
        srcpath = os.path.join(filedir, '../templates/xilinx/vivado_synth.tcl')
        dstpath = f'{model.config.get_output_dir()}/vivado_synth.tcl'
        copyfile(srcpath, dstpath)

        # build_lib.sh
        f = open(os.path.join(filedir, '../templates/xilinx/build_lib.sh'))
    ...
    def write_nnet_utils(self, model):
        ...
        srcpath = os.path.join(filedir, '../templates/xilinx/nnet_utils/')
        ...
        srcpath = os.path.join(filedir, '../templates/xilinx/ap_types/')
