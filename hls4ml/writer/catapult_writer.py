...
class CatapultWriter(Writer):
    ...
    def write_bridge(self, model):
        ...
        filedir = os.path.dirname(os.path.abspath(__file__))
        f = open(os.path.join(filedir,'../templates/catapult/myproject_bridge.cpp'),'r')
    ...
    def write_build_script(self, model):
        ...
        f = open(os.path.join(filedir,'../templates/catapult/catapult_synth.tcl'),'r')
        fout = open('{}/catapult_synth.tcl'.format(model.config.get_output_dir()),'w')
        for line in f.readlines():
            line = line.replace('myproject', model.config.get_project_name())
            if '-part' in line:
